...
11. Confine the date range by modifying the start date and inputting an end date. (If left blank, events will be added to all chosen letter days, starting from today and ending one year from today.)
